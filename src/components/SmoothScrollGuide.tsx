...
export function SmoothScrollGuide() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 py-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {[
          {
            ...
            description:
            'Natural deceleration with velocity-based easing for smooth, realistic motion',
            icon: '⚡'
          },
          {
            title: 'Touch Inertia',
            description:
            'Flick gestures with momentum carry-through for mobile-friendly interactions',
            icon: '👆'
          },
          {
            title: 'Customizable Easing',
            description:
            'Multiple easing functions including Lenis-style cubic bezier curves',
            icon: '📈'
          },
          {
            title: 'Frame Independent',
            description:
            'Delta time calculations ensure consistent animation across all frame rates',
            icon: '🎬'
          },
          {
            title: 'Programmatic Control',
            description:
            'ScrollTo, scrollBy, and stop methods for complete scroll control',
            icon: '🎮'
          },
          {
            title: 'Scroll Data API',
            description:
            'Real-time access to scroll position, velocity, direction, and progress',
            icon: '📊'
          }].
          map((feature, index) =>
          <motion.div
        ...
        <motion.div
          ...
          <div className="space-y-4">
            {[
            {
              ...
              default: '0.1',
              description:
              'Linear interpolation factor. Lower = smoother but slower, Higher = more responsive'
            },
            {
              option: 'damping',
              type: 'number (0-1)',
              default: '0.9',
              description:
              'Momentum damping factor. Controls how quickly velocity decays'
            },
            {
              ...
              default: '1.0',
              description:
              'Wheel scroll sensitivity multiplier. Increase for faster scrolling'
            },
            {
              ...
              default: '1.5',
              description:
              'Touch scroll sensitivity multiplier. Adjust for mobile feel'
            },
            {
              option: 'touchInertia',
              type: 'number (0-1)',
              default: '0.95',
              description:
              'Touch inertia factor. Controls flick gesture momentum'
            },
            {
              option: 'orientation',
