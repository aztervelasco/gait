...
const churchData = {
  ...
  established: '2021',
  tagline: 'Growing in Faith, Serving with Love',
  description:
  'Timmuri Church is a growing congregation dedicated to serving the community with faith, hope, and love. Known as the "Ark of Timmuri," this church is committed to building strong relationships, nurturing spiritual growth, and reaching families with the transforming message of the Gospel.',
  heroImage: "/506020317_10229095814600826_8093534636738664874_n.webp",
  ...
  {
    url: "/timmuri1.webp",
    caption: 'Prayer and Worship'
  },
  {
    url: "/480809093_2053084111783469_2798213937889228487_n.webp",
    caption: 'Church Dedication'
  },
  {
    url: "/504932763_10229044435436379_3992651057210061365_n.webp",
    caption: 'Worship Service'
  },
  {
    url: "/501169598_10228891022641155_7598878957010397695_n.webp",
    caption: 'Church Building'
  }],

  mission:
  'To be a faithful community that brings the Gospel to every household in Ocao Capiniaan and the surrounding areas, building disciples who love God and serve others with compassion and dedication.',
  vision:
  "To see the Timmuri community transformed by the love of Christ, where every family experiences hope, healing, and the joy of belonging to God's family."
};
    ...
    <div className="w-full min-h-screen bg-dark-premium overflow-x-hidden">
      ...
      <section className="relative w-full h-[100svh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-teal-900/30 via-transparent to-cyan-900/20"></div>
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute w-1.5 h-1.5 md:w-2 md:h-2 bg-teal-300 rounded-full blur-[1px]"
            style={{
              left: `${10 + i * 12}%`,
              bottom: '5%'
            }} />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            ...
            className="absolute -top-32 -right-32 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-teal-500 rounded-full blur-[120px]" />
          ...
          <motion.div
            ...
            className="absolute -bottom-32 -left-32 w-[250px] md:w-[400px] h-[250px] md:h-[400px] bg-cyan-500 rounded-full blur-[100px]" />
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6">
          <motion.div
            ...
            <motion.div
              ...
              <span className="inline-flex items-center gap-2 text-teal-300 text-xs sm:text-sm font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase bg-white/10 backdrop-blur-md px-4 sm:px-8 py-2 sm:py-3 rounded-full border border-teal-400/30 shadow-lg shadow-teal-500/10">
            ...
            <div className="overflow-hidden mb-4 md:mb-6">
              <motion.h1
                ...
                <motion.span
                  className="block text-transparent bg-clip-text bg-gradient-to-r from-teal-200 via-cyan-100 to-teal-200 bg-[length:200%_auto]"
                  animate={{
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl md:text-2xl text-teal-100/90 mb-6 md:mb-8 font-light">
            ...
            <motion.div
              ...
              <div className="flex items-center gap-2 sm:gap-3 text-base sm:text-lg md:text-xl text-gray-200 bg-white/5 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-white/10">
                <MapPinIcon className="w-4 h-4 sm:w-5 sm:h-5 text-teal-300 flex-shrink-0" />
      ...
      <section
        id="about"
        className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 bg-gradient-to-br from-white via-teal-50/30 to-white relative overflow-hidden">
          ...
          <motion.div
            ...
            <div>
              <motion.div
                ...
                className="inline-flex items-center gap-2 text-teal-700 text-xs sm:text-sm font-bold tracking-widest uppercase mb-4 bg-teal-100 px-4 py-2 rounded-full">
              ...
              <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
                Since 2021, Timmuri Church has been a place where people can
                find belonging, purpose, and spiritual growth. We are committed
                to walking together in faith and serving our community with joy.
              </p>
            </div>
            ...
            <motion.div
              ...
              <motion.div
                ...
                className="absolute -inset-2 bg-gradient-to-r from-teal-500/20 via-cyan-500/20 to-teal-500/20 rounded-3xl blur-xl" />
              

              <div className="relative bg-gradient-to-br from-teal-600 via-cyan-600 to-teal-700 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-2xl shadow-teal-500/20">
                  ...
                  <motion.div
                    ...
                    className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-white/10">
                      ...
                      <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div>
                          <p className="text-teal-200 font-semibold text-sm sm:text-base">
                            {service.day}
                          </p>
                ...
                <div className="mt-6 pt-6 border-t border-white/20">
                  <div className="flex items-start gap-3">
                    <MapPinIcon className="w-5 h-5 text-teal-200 flex-shrink-0 mt-0.5" />
                    <p className="text-teal-100 text-sm sm:text-base">
                      {churchData.location}
                    </p>
                  </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <motion.div
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-teal-500/20 to-cyan-500/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-white/10 h-full">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-teal-500/20">
            ...
            <motion.div
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/20 to-teal-500/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-white/10 h-full">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg shadow-cyan-500/20">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div
            ...
            <motion.div
              ...
              {/* Decorative Frame */}
              <div className="absolute inset-0 border-2 border-teal-500/20 rounded-2xl sm:rounded-3xl pointer-events-none z-20" />
              ...
              <button
                onClick={prevSlide}
                className="hidden sm:flex absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-white/20 hover:bg-teal-500/40 backdrop-blur-sm rounded-full items-center justify-center text-white transition-all duration-300 hover:scale-110 z-10"
              ...
              <button
                onClick={nextSlide}
                className="hidden sm:flex absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-white/20 hover:bg-teal-500/40 backdrop-blur-sm rounded-full items-center justify-center text-white transition-all duration-300 hover:scale-110 z-10"
      ...
      {/* Call to Action */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 bg-gradient-to-br from-teal-900 via-cyan-900 to-teal-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            <p className="text-base sm:text-xl text-teal-100 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto px-4">
              Everyone is welcome at Timmuri Church!
            </p>
