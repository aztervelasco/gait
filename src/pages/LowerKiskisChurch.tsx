...
const churchData = {
  ...
  established: '2019',
  tagline: 'Faith Growing in the Valley',
  description:
  'Lower Kiskis Church is a vibrant community of believers nestled in the beautiful valley of Santa Fe. Since our establishment in 2019, we have been committed to spreading the Gospel and nurturing spiritual growth among our members. Our church is known for its warm fellowship, passionate worship, and dedication to serving the community.',
  heroImage: "/517975162_10229908257351387_8288140229065852926_n.webp",
  ...
  gallery: [
  {
    url: "/524739579_10230153083231881_5556701308524849185_n.webp",
    caption: 'Church Leaders'
  },
  {
    url: "/517725546_10229891160163968_7677830931699788429_n.webp",
    caption: 'Youth Worship'
  },
  {
    url: "/518177236_10229891162924037_8651603236976255502_n.webp",
    caption: 'Building Progress'
  },
  {
    url: "/472599763_531916002641906_8981263328935383503_n.webp",
  ...
  vision:
  'To see every person in Lower Kiskis and beyond encounter the life-changing power of Jesus Christ. We envision a community where faith is lived out daily, families are strengthened, and the Kingdom of God advances through our witness.'
};
export function LowerKiskisChurch() {
  ...
  return (
    <div className="w-full min-h-screen bg-dark-premium overflow-x-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 sm:px-6">
          <motion.div
            ...
            <motion.div
              ...
              <a
                href="#gallery"
                className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-full transition-all duration-300 hover:scale-105 active:scale-95 shadow-xl shadow-rose-500/25 text-sm sm:text-base">
      ...
      <section
        id="about"
        className="py-16 sm:py-24 px-4 sm:px-6 md:px-12 bg-gradient-to-br from-white via-rose-50/30 to-white relative overflow-hidden">
          ...
          <motion.div
            ...
            <div>
              <motion.div
                ...
                className="inline-flex items-center gap-2 text-rose-700 text-xs sm:text-sm font-bold tracking-widest uppercase mb-4 bg-rose-100 px-4 py-2 rounded-full">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            <p className="text-base sm:text-xl text-rose-100 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto px-4">
              ...
              community. Everyone is welcome at Lower Kiskis Church!
            </p>
