...
const churchData = {
  name: 'Putlan Church',
  abbreviation: 'LHGCF',
  location: 'Putlan, Municipality of Carranglan, Province of Nueva Ecija',
  established: 'Affiliate Church',
  tagline: 'Spreading Hope in Carranglan',
  description:
  'Putlan Church is a vibrant community of believers dedicated to sharing the living hope and grace found in Jesus Christ. Located in the heart of Carranglan, we strive to be a light to our neighbors and a home for those seeking spiritual growth and genuine fellowship.',
  ...
  gallery: [
  {
    url: "/03dfe1f1-cdfa-48fa-a403-89cd0edb08e3.webp",
    caption: 'Church Community'
  },
  {
    url: "/d47d26b4-2403-41b3-90af-5451aea87ed0.webp",
    caption: "Children's Ministry"
  },
  {
    url: "/43458d35-62c9-4101-aedf-a1a6dd2f5dde.webp",
    caption: 'Youth Leader'
  },
  {
    url: "/d47d26b4-2403-41b3-90af-5451aea87ed0-1.webp",
    caption: 'Elders'
  }],

  mission:
  'To proclaim the Gospel of grace to the people of Putlan, making disciples who walk in the hope of Christ and serve their community with love.',
  vision:
  'A transformed community in Putlan where every family experiences the grace of God and lives out the hope of the Gospel.'
};
          ...
          <motion.div
            ...
            <div>
              ...
              <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                Putlan Church is proud to be part of the Living Hope and Grace
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            <p className="text-base sm:text-xl text-emerald-100 mb-8 sm:mb-10 leading-relaxed max-w-2xl mx-auto px-4">
              Everyone is welcome at Putlan Church!
            </p>
